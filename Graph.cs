...
namespace DRnamespace
{
    public class Graph
    {
        ...
        public void Initial(double Left, double Top, double Width, double Height)
        {
            ...
            bmp_new = new Bitmap(width, height, PixelFormat.Format32bppArgb);
            bmp_last = new Bitmap(width, height, PixelFormat.Format32bppArgb);
        ...
        public Boolean IsScreenChanged()
        {
            ...
            if (DetectDifference)
            {
                var a_b = bmp_new.LockBits(new Rectangle(new Point(0, 0), bmp_new.Size), ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
                var b_b = bmp_last.LockBits(new Rectangle(new Point(0, 0), bmp_last.Size), ImageLockMode.ReadOnly, PixelFormat.Format32bppArgb);
        ...
        public void Capture()
        {
            bitGraph.CopyFromScreen(px, py, 0, 0, new Size(width, height));
        }
